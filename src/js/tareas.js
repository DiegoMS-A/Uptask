...
(function () {
    ...
    function mostrarTareas() {
        ...
        if (arrayTareas.length === 0) {
            const contenedorTarea = document.querySelector('#listado-tareas');
            const textoNoTareas = document.createElement('LI');
            textoNoTareas.textContent = 'No Hay Tareas';
            textoNoTareas.classList.add('no-tareas');

            contenedorTarea.appendChild(textoNoTareas);
            return
        }
    ...
    //Muestra mensaje en interface
    function mostrarAlerta(mensaje, tipo, referencia) {
        //Previene la creación de múltiples tareas
    ...
    //Consultar servidor y agregar tarea
    async function agregarTarea(tarea) {
        ...
        try {
            ...
            //AGREGAR EL OBJETO DE TAREA AL GLOBABL DE TAREAS
            const tareaObj = {
